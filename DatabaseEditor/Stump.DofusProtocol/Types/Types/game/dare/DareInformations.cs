...
public DareInformations(double dareId, Types.CharacterBasicMinimalInformations creator, int subscriptionFee, int jackpot, ushort maxCountWinners, double endDate, bool isPrivate, uint guildId, uint allianceId, IEnumerable<Types.DareCriteria> criterions, double startDate)
        {
            this.dareId = dareId;
...
dareId = reader.ReadDouble();
            ...
            if (endDate < 0 || endDate > 9.007199254740992E15)
                throw new Exception("Forbidden value on endDate = " + endDate + ", it doesn't respect the following condition : endDate < 0 || endDate > 9.007199254740992E15");
            ...
            if (startDate < 0 || startDate > 9.007199254740992E15)
                throw new Exception("Forbidden value on startDate = " + startDate + ", it doesn't respect the following condition : startDate < 0 || startDate > 9.007199254740992E15");
