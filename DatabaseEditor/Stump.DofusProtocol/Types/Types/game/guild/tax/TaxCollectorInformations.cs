...
uniqueId = reader.ReadInt();
            ...
            {
                 (complements as Types.TaxCollectorComplementaryInformations[])[i] = ProtocolTypeManager.GetInstance<Types.TaxCollectorComplementaryInformations>(reader.ReadShort());
