...
public PartyInvitationMemberInformations(ulong id, string name, byte level, Types.EntityLook entityLook, sbyte breed, bool sex, short worldX, short worldY, int mapId, ushort subAreaId, IEnumerable<Types.PartyCompanionBaseInformations> companions)
