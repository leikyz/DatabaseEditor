...
fightId = reader.ReadInt();
            ...
            {
                 (attackers as Types.GameFightFighterLightInformations[])[i] = ProtocolTypeManager.GetInstance<Types.GameFightFighterLightInformations>(reader.ReadShort());
            ...
            for (int i = 0; i < limit; i++)
            {
                 (defenders as Types.GameFightFighterLightInformations[])[i] = ProtocolTypeManager.GetInstance<Types.GameFightFighterLightInformations>(reader.ReadShort());
