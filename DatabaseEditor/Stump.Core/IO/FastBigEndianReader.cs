...
namespace Stump.Core.IO
{
    public unsafe class FastBigEndianReader : IDataReader, IDisposable
    {
        ...
        public long BytesAvailable
        {
            get
            {
                return ((this.m_maxPosition > 0L) ? this.m_maxPosition : ((long)this.m_buffer.Length)) - this.Position;
            }
        }
        ...
        public FastBigEndianReader(BufferSegment segment)
        {
            ...
            this.Position = (long)segment.Offset;
            this.m_maxPosition = (long)(segment.Offset + segment.Length);
        }
        ...
        public void Seek(int offset, SeekOrigin seekOrigin)
        {
            ...
            else
            {
                ...
                {
                    this.Position = (long)(this.m_buffer.Length + offset);
                }
                else
                {
